...
class EmailNotificationProvider(NotificationProvider):
    ...
    def prepare_content(self, user_name: str, game_name: str, current_price: float, target_price: float, deal_url: str, image_url: str | None) -> str:
        """Helper para preparar o conteúdo HTML específico de email"""
        return self._get_html_template(user_name, game_name, current_price, target_price, deal_url, image_url)
